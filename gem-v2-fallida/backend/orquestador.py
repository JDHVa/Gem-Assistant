...
class Orquestador:
    ...
    async def iniciar(self) -> None:
        ...
        # Configurar el callback de amplitud para que envíe al frontend vía broadcaster
    ...
    async def _enviar_lipsync(self, rms: float, terminado: bool):
        """Envía el RMS al frontend para animación labial."""
    ...
    def _construir_prompt(self, fragmentos: list[str]) -> str:
        ...
        return construir_prompt(
            ...
            vtube_activo=False,  # ya no usamos VTube
    ...
    async def _pipeline(self, texto_usuario: str) -> str:
        ...
        # Enviar emoción actual al frontend para el avatar
        await self._broadcaster.broadcast(
